  ...
  if (isDemoMode()) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-semibold">Analytics (Demo)</h1>
        <div className="grid gap-4 md:grid-cols-4">
          <div className="rounded-lg border border-slate-200 p-4"><p className="text-sm text-slate-600">Total views</p><p className="text-2xl font-semibold">{demoAnalytics.totalViews}</p></div>
          <div className="rounded-lg border border-slate-200 p-4"><p className="text-sm text-slate-600">Unique viewers</p><p className="text-2xl font-semibold">{demoAnalytics.uniqueViewers}</p></div>
          <div className="rounded-lg border border-slate-200 p-4"><p className="text-sm text-slate-600">Downloads</p><p className="text-2xl font-semibold">{demoAnalytics.downloads}</p></div>
          <div className="rounded-lg border border-slate-200 p-4"><p className="text-sm text-slate-600">Captured submissions</p><p className="text-2xl font-semibold">{demoAnalytics.submissions}</p></div>
        </div>
        <p className="text-sm text-muted-foreground">Demo dataset includes {demoDocuments.length} documents and {demoSpaces.length} spaces.</p>
      </div>
    );
  }
