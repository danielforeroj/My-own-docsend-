      ...
      <form action={createSpace} className="space-y-4 rounded-lg border border-slate-200 p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <select className="w-full" name="visibility" defaultValue="private">
          ...
          <div className="space-y-2">
            ...
            <input name="public_slug" className="w-full" />
          </div>
        </div>

        <label className="flex items-center gap-2 text-sm">
          <input type="checkbox" name="show_in_catalog" /> Show in public catalog
        </label>
